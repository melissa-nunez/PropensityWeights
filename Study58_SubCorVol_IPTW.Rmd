...
Baseline Differences in Subcortical Volume Between Random Groups. Regression model for last column is sub_cor_measure_baseline = random_group + np_gender + IntraCranialVolume.x + np_age where sub_cor_measure_baseline is the subcortical volume measure being analyzed.
